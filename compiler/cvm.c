...
char* op_names[256];
int is_init_op_names = 0;
void init_op_names (void) {
  is_init_op_names = 1;
  op_names[0] = "SET_OPCODE_LOCAL";
  op_names[1] = "SET_OPCODE_UNSIGNED";
  op_names[2] = "SET_OPCODE_SIGNED";
  op_names[3] = "SET_OPCODE_CODE";
  op_names[5] = "SET_OPCODE_GLOBAL";
  op_names[6] = "SET_OPCODE_DATA";
  op_names[7] = "SET_OPCODE_CONST";
  op_names[8] = "SET_OPCODE_WIDE";
  op_names[9] = "SET_REG_OPCODE_LOCAL";
  op_names[10] = "SET_REG_OPCODE_UNSIGNED";
  op_names[11] = "SET_REG_OPCODE_SIGNED";
  op_names[12] = "SET_REG_OPCODE_CODE";
  op_names[14] = "SET_REG_OPCODE_GLOBAL";
  op_names[15] = "SET_REG_OPCODE_DATA";
  op_names[16] = "SET_REG_OPCODE_CONST";
  op_names[17] = "SET_REG_OPCODE_WIDE";
  op_names[18] = "GET_REG_OPCODE";
  op_names[19] = "CALL_OPCODE_LOCAL";
  op_names[20] = "CALL_OPCODE_CODE";
  op_names[22] = "CALL_CLOSURE_OPCODE";
  op_names[23] = "TCALL_OPCODE_LOCAL";
  op_names[24] = "TCALL_OPCODE_CODE";
  op_names[26] = "TCALL_CLOSURE_OPCODE";
  op_names[27] = "CALLC_OPCODE_LOCAL";
  op_names[28] = "CALLC_OPCODE_WIDE";
  op_names[30] = "POP_FRAME_OPCODE";
  op_names[31] = "LIVE_OPCODE";
  op_names[32] = "YIELD_OPCODE";
  op_names[33] = "RETURN_OPCODE";
  op_names[34] = "DUMP_OPCODE";
  op_names[35] = "INT_ADD_OPCODE";
  op_names[36] = "INT_SUB_OPCODE";
  op_names[37] = "INT_MUL_OPCODE";
  op_names[38] = "INT_DIV_OPCODE";
  op_names[39] = "INT_MOD_OPCODE";
  op_names[40] = "INT_AND_OPCODE";
  op_names[41] = "INT_OR_OPCODE";
  op_names[42] = "INT_XOR_OPCODE";
  op_names[43] = "INT_SHL_OPCODE";
  op_names[44] = "INT_SHR_OPCODE";
  op_names[45] = "INT_ASHR_OPCODE";
  op_names[46] = "INT_LT_OPCODE";
  op_names[47] = "INT_GT_OPCODE";
  op_names[48] = "INT_LE_OPCODE";
  op_names[49] = "INT_GE_OPCODE";
  op_names[50] = "EQ_OPCODE_REF_REF";
  op_names[51] = "EQ_OPCODE_REF";
  op_names[52] = "EQ_OPCODE_BYTE";
  op_names[53] = "EQ_OPCODE_INT";
  op_names[54] = "EQ_OPCODE_LONG";
  op_names[55] = "EQ_OPCODE_FLOAT";
  op_names[56] = "EQ_OPCODE_DOUBLE";
  op_names[57] = "NE_OPCODE_REF_REF";
  op_names[58] = "NE_OPCODE_REF";
  op_names[59] = "NE_OPCODE_BYTE";
  op_names[60] = "NE_OPCODE_INT";
  op_names[61] = "NE_OPCODE_LONG";
  op_names[62] = "NE_OPCODE_FLOAT";
  op_names[63] = "NE_OPCODE_DOUBLE";
  op_names[64] = "ADD_OPCODE_BYTE";
  op_names[65] = "ADD_OPCODE_INT";
  op_names[66] = "ADD_OPCODE_LONG";
  op_names[67] = "ADD_OPCODE_FLOAT";
  op_names[68] = "ADD_OPCODE_DOUBLE";
  op_names[69] = "SUB_OPCODE_BYTE";
  op_names[70] = "SUB_OPCODE_INT";
  op_names[71] = "SUB_OPCODE_LONG";
  op_names[72] = "SUB_OPCODE_FLOAT";
  op_names[73] = "SUB_OPCODE_DOUBLE";
  op_names[74] = "MUL_OPCODE_BYTE";
  op_names[75] = "MUL_OPCODE_INT";
  op_names[76] = "MUL_OPCODE_LONG";
  op_names[77] = "MUL_OPCODE_FLOAT";
  op_names[78] = "MUL_OPCODE_DOUBLE";
  op_names[79] = "DIV_OPCODE_BYTE";
  op_names[80] = "DIV_OPCODE_INT";
  op_names[81] = "DIV_OPCODE_LONG";
  op_names[82] = "DIV_OPCODE_FLOAT";
  op_names[83] = "DIV_OPCODE_DOUBLE";
  op_names[84] = "MOD_OPCODE_BYTE";
  op_names[85] = "MOD_OPCODE_INT";
  op_names[86] = "MOD_OPCODE_LONG";
  op_names[87] = "AND_OPCODE_BYTE";
  op_names[88] = "AND_OPCODE_INT";
  op_names[89] = "AND_OPCODE_LONG";
  op_names[90] = "OR_OPCODE_BYTE";
  op_names[91] = "OR_OPCODE_INT";
  op_names[92] = "OR_OPCODE_LONG";
  op_names[93] = "XOR_OPCODE_BYTE";
  op_names[94] = "XOR_OPCODE_INT";
  op_names[95] = "XOR_OPCODE_LONG";
  op_names[96] = "SHL_OPCODE_BYTE";
  op_names[97] = "SHL_OPCODE_INT";
  op_names[98] = "SHL_OPCODE_LONG";
  op_names[99] = "SHR_OPCODE_BYTE";
  op_names[100] = "SHR_OPCODE_INT";
  op_names[101] = "SHR_OPCODE_LONG";
  op_names[103] = "ASHR_OPCODE_INT";
  op_names[104] = "ASHR_OPCODE_LONG";
  op_names[105] = "LT_OPCODE_INT";
  op_names[106] = "LT_OPCODE_LONG";
  op_names[107] = "LT_OPCODE_FLOAT";
  op_names[108] = "LT_OPCODE_DOUBLE";
  op_names[109] = "GT_OPCODE_INT";
  op_names[110] = "GT_OPCODE_LONG";
  op_names[111] = "GT_OPCODE_FLOAT";
  op_names[112] = "GT_OPCODE_DOUBLE";
  op_names[113] = "LE_OPCODE_INT";
  op_names[114] = "LE_OPCODE_LONG";
  op_names[115] = "LE_OPCODE_FLOAT";
  op_names[116] = "LE_OPCODE_DOUBLE";
  op_names[117] = "GE_OPCODE_INT";
  op_names[118] = "GE_OPCODE_LONG";
  op_names[119] = "GE_OPCODE_FLOAT";
  op_names[120] = "GE_OPCODE_DOUBLE";
  op_names[121] = "ULE_OPCODE_BYTE";
  op_names[122] = "ULE_OPCODE_INT";
  op_names[123] = "ULE_OPCODE_LONG";
  op_names[124] = "ULT_OPCODE_BYTE";
  op_names[125] = "ULT_OPCODE_INT";
  op_names[126] = "ULT_OPCODE_LONG";
  op_names[127] = "UGT_OPCODE_BYTE";
  op_names[128] = "UGT_OPCODE_INT";
  op_names[129] = "UGT_OPCODE_LONG";
  op_names[130] = "UGE_OPCODE_BYTE";
  op_names[131] = "UGE_OPCODE_INT";
  op_names[132] = "UGE_OPCODE_LONG";
  op_names[133] = "INT_NOT_OPCODE";
  op_names[134] = "INT_NEG_OPCODE";
  op_names[135] = "NOT_OPCODE_BYTE";
  op_names[136] = "NOT_OPCODE_INT";
  op_names[137] = "NOT_OPCODE_LONG";
  op_names[138] = "NEG_OPCODE_INT";
  op_names[139] = "NEG_OPCODE_LONG";
  op_names[140] = "NEG_OPCODE_FLOAT";
  op_names[141] = "NEG_OPCODE_DOUBLE";
  op_names[142] = "DEREF_OPCODE";
  op_names[143] = "TYPEOF_OPCODE";
  op_names[144] = "JUMP_SET_OPCODE";
  op_names[145] = "GOTO_OPCODE";
  op_names[146] = "CONV_OPCODE_BYTE_FLOAT";
  op_names[147] = "CONV_OPCODE_BYTE_DOUBLE";
  op_names[148] = "CONV_OPCODE_INT_BYTE";
  op_names[149] = "CONV_OPCODE_INT_FLOAT";
  op_names[150] = "CONV_OPCODE_INT_DOUBLE";
  op_names[151] = "CONV_OPCODE_LONG_BYTE";
  op_names[152] = "CONV_OPCODE_LONG_INT";
  op_names[153] = "CONV_OPCODE_LONG_FLOAT";
  op_names[154] = "CONV_OPCODE_LONG_DOUBLE";
  op_names[155] = "CONV_OPCODE_FLOAT_BYTE";
  op_names[156] = "CONV_OPCODE_FLOAT_INT";
  op_names[157] = "CONV_OPCODE_FLOAT_LONG";
  op_names[158] = "CONV_OPCODE_FLOAT_DOUBLE";
  op_names[159] = "CONV_OPCODE_DOUBLE_BYTE";
  op_names[160] = "CONV_OPCODE_DOUBLE_INT";
  op_names[161] = "CONV_OPCODE_DOUBLE_LONG";
  op_names[162] = "CONV_OPCODE_DOUBLE_FLOAT";
  op_names[163] = "DETAG_OPCODE";
  op_names[164] = "TAG_OPCODE_BYTE";
  op_names[165] = "TAG_OPCODE_CHAR";
  op_names[166] = "TAG_OPCODE_INT";
  op_names[167] = "TAG_OPCODE_FLOAT";
  op_names[168] = "STORE_OPCODE_1";
  op_names[169] = "STORE_OPCODE_4";
  op_names[170] = "STORE_OPCODE_8";
  op_names[171] = "STORE_OPCODE_1_VAR_OFFSET";
  op_names[172] = "STORE_OPCODE_4_VAR_OFFSET";
  op_names[173] = "STORE_OPCODE_8_VAR_OFFSET";
  op_names[174] = "LOAD_OPCODE_1";
  op_names[175] = "LOAD_OPCODE_4";
  op_names[176] = "LOAD_OPCODE_8";
  op_names[177] = "LOAD_OPCODE_1_VAR_OFFSET";
  op_names[178] = "LOAD_OPCODE_4_VAR_OFFSET";
  op_names[179] = "LOAD_OPCODE_8_VAR_OFFSET";
  op_names[180] = "RESERVE_OPCODE_LOCAL";
  op_names[181] = "RESERVE_OPCODE_CONST";
  op_names[182] = "ENTER_STACK_OPCODE";
  op_names[183] = "ALLOC_OPCODE_CONST";
  op_names[184] = "ALLOC_OPCODE_LOCAL";
  op_names[185] = "GC_OPCODE";
  op_names[186] = "PRINT_STACK_TRACE_OPCODE";
  op_names[188] = "FLUSH_VM_OPCODE";
  op_names[243] = "C_RSP_OPCODE";
  op_names[192] = "JUMP_INT_LT_OPCODE";
  op_names[193] = "JUMP_INT_GT_OPCODE";
  op_names[194] = "JUMP_INT_LE_OPCODE";
  op_names[195] = "JUMP_INT_GE_OPCODE";
  op_names[196] = "JUMP_EQ_OPCODE_REF";
  op_names[197] = "JUMP_EQ_OPCODE_BYTE";
  op_names[198] = "JUMP_EQ_OPCODE_INT";
  op_names[199] = "JUMP_EQ_OPCODE_LONG";
  op_names[200] = "JUMP_EQ_OPCODE_FLOAT";
  op_names[201] = "JUMP_EQ_OPCODE_DOUBLE";
  op_names[202] = "JUMP_NE_OPCODE_REF";
  op_names[203] = "JUMP_NE_OPCODE_BYTE";
  op_names[204] = "JUMP_NE_OPCODE_INT";
  op_names[205] = "JUMP_NE_OPCODE_LONG";
  op_names[206] = "JUMP_NE_OPCODE_FLOAT";
  op_names[207] = "JUMP_NE_OPCODE_DOUBLE";
  op_names[208] = "JUMP_LT_OPCODE_INT";
  op_names[209] = "JUMP_LT_OPCODE_LONG";
  op_names[210] = "JUMP_LT_OPCODE_FLOAT";
  op_names[211] = "JUMP_LT_OPCODE_DOUBLE";
  op_names[212] = "JUMP_GT_OPCODE_INT";
  op_names[213] = "JUMP_GT_OPCODE_LONG";
  op_names[214] = "JUMP_GT_OPCODE_FLOAT";
  op_names[215] = "JUMP_GT_OPCODE_DOUBLE";
  op_names[216] = "JUMP_LE_OPCODE_INT";
  op_names[217] = "JUMP_LE_OPCODE_LONG";
  op_names[218] = "JUMP_LE_OPCODE_FLOAT";
  op_names[219] = "JUMP_LE_OPCODE_DOUBLE";
  op_names[220] = "JUMP_GE_OPCODE_INT";
  op_names[221] = "JUMP_GE_OPCODE_LONG";
  op_names[222] = "JUMP_GE_OPCODE_FLOAT";
  op_names[223] = "JUMP_GE_OPCODE_DOUBLE";
  op_names[224] = "JUMP_ULE_OPCODE_BYTE";
  op_names[225] = "JUMP_ULE_OPCODE_INT";
  op_names[226] = "JUMP_ULE_OPCODE_LONG";
  op_names[227] = "JUMP_ULT_OPCODE_BYTE";
  op_names[228] = "JUMP_ULT_OPCODE_INT";
  op_names[229] = "JUMP_ULT_OPCODE_LONG";
  op_names[230] = "JUMP_UGT_OPCODE_BYTE";
  op_names[231] = "JUMP_UGT_OPCODE_INT";
  op_names[232] = "JUMP_UGT_OPCODE_LONG";
  op_names[233] = "JUMP_UGE_OPCODE_BYTE";
  op_names[234] = "JUMP_UGE_OPCODE_INT";
  op_names[235] = "JUMP_UGE_OPCODE_LONG";
  op_names[236] = "DISPATCH_OPCODE";
  op_names[237] = "DISPATCH_METHOD_OPCODE";
  op_names[238] = "JUMP_REG_OPCODE";
  op_names[239] = "FNENTRY_OPCODE";
  op_names[240] = "JUMP_TAGBITS_OPCODE";
  op_names[241] = "CLASS_NAME_OPCODE";
  op_names[242] = "JUMP_TAGWORD_OPCODE";
}
...
void vmloop (VMState* vms, uint64_t stanza_crsp){
  ...
  if (!is_init_op_names) init_op_names();
  ...
  while(1){
    ...
    //printf("%08x: OP %s\n", pc - instructions, op_names[opcode]);
